...
import src.models.models  # type: ignore  # noqa: F401
...
def run_migrations_offline() -> None:
    ...
    """
    # Prefer env var DATABASE_URL, fallback to ini file
...
def run_migrations_online() -> None:
    ...
    url = os.getenv("DATABASE_URL", cfg_section.get("sqlalchemy.url"))
    if url:
